...
data1 = data1.append(dffromdirectory(r'C:\Users\jaspr\PycharmProjects\SPAM_DETECTOR\emails\spam', 'spam'))
data1 = data1.append(dffromdirectory(r'C:\Users\jaspr\PycharmProjects\SPAM_DETECTOR\emails\ham', 'ham'))
