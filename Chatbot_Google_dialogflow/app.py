...
def processRequest(req):
    ...
    #print(person_name)
    person_contact = parameters.get("person_contact")
    person_email=parameters.get("person_email")
    ...
    if (intent=='course_selection'):
        ...
        email_sender.send_email_to_student(person_email,email_message)
        email_file_support = open("email_templates/support_team_Template.html", "r")
        email_message_support = email_file_support.read()
        email_sender.send_email_to_support(person_name=person_name,person_contact=person_contact,person_email=person_email,course_name=course_name,body=email_message_support)
